...
Unknown provider event types keep their provider ID and name with a null canonical mapping. Out-of-bounds coordinates remain unchanged while normalized coordinates stay null. Task 11 owns validation findings and quality-report publication.
