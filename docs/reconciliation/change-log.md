...
| --- | --- | --- |
| PLAN grew into repeated schema+experiment manual | Compact root execution roadmap; detailed original sections retained under individual docs and complete archive. | `PLAN.md`, `docs/README.md` |
| Forecast versus enrichment mixed together | Sealed candidate, independently validated production publish, then optional enrichment; common hash/permissible presentation rules. | Artifact boundaries, forecast/enrichment contracts, publication state machine |
| No formal decisions and experiments | Decision template, no invented signed events, experiment ledger and explicit research/evaluation/engine/promotion/enablement transitions. | Governance directory |
| Research capability confused with production enablement | Proposed registry schema but no guessed live states; signed event required for promotion and activation. | Capability registry, promotion gates |
| No canonical immutability evidence | Versioned probability/artifact/validation hashes, proposed cross-language decimal/JCS byte policy with golden-fixture acceptance, parity and dependency checks. | Hash contract and enrichment-parity tests |
| Forecast DoD ambiguous | Five separate completion definitions: sealed analytic candidate, Rust evidence, public forecast, enrichment, predictive promotion. | Root PLAN, definitions of done |
